...
$(document).ready(function()
{
	...
	*/
	...
	function activeClassArrow(){
		if('.subList'){
			$('.subList').parent('.subUl').parent('.catList').addClass('hassubs');
			
		}
	}

	function arCat(){
		$('.main_slider').parent('.super_container').addClass('arCatShow')	
		if(window.innerWidth < 992 )
			{
				$('.main_slider').parent('.super_container').removeClass('arCatShow')	
	...
	function initMainSlider()
	{
		if($('.main_slider').length)
		{
			...
			mainSlider.owlCarousel(
			{
				items:1,
				loop:true,
				navClass:['main_slider_prev', 'main_slider_next'],
				nav:false,
				dots:false,
				smartSpeed:1200,
				margin:30,
