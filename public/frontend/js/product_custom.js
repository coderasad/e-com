...
$(document).ready(function()
{
	...
	function initColor()
	{
		if($('.product_color').length)
		{
			...
			colorItems.each(function()
			{
				...
				{
					var color = colorItem.css('backgroundColor');
					var data = colorItem.attr('data');
					selectedCol.css('backgroundColor', color);
					selectedCol.attr('data',data);
				});
			});
		}
	}
	...
	*/
	...
	function initSize()
	{
		...
		{
			var selectedCol = $('#selected_size');
			var sizeItems = $('.size_list li .size_mark');
			sizeItems.each(function()
			{
				var sizeItem = $(this);
				var size = sizeItem.text();
				selectedCol.html(size);
